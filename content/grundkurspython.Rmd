...
Seit Python 3 ist der Codeschnipsel `# -*- coding: utf-8 -*-` eigentlich nicht mehr notwendig, aber da ich noch nicht herausgefunden habe, wie ich RStudios Notebook, in dem ich diesen Text schreibe, auf mein Anaconda-Python umbiegen kann, nutzt RStudio zur Zeit noch das Syste4m-Python von Apple und das ist -- wie oben schon angemerkt -- ein 2.7.5 ohne wirkliche Unicode-Unterstützung. Aber auch in Python 3 stört der Schnipsel nicht, er wird einfach als Kommentar behandelt.